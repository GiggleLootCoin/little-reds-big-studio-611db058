...
export const FREE_RUNNERS: FreeRunner[] = [
  ...
  },
  {
    ...
    notes: "Primary free music route; current public Space uses ZeroGPU.",
    priority: 160,
  },
  {
    id: "hf-diffrhythm2",
    ...
    notes: "Strong free full-song fallback with a currently running ZeroGPU Space.",
    priority: 145,
  },
  {
    id: "hf-ace-step",
  ...
  },
  {
    ...
    notes: "Official Qwen Space currently running on ZeroGPU; supports Voice Design, Voice Clone and CustomVoice.",
    priority: 175,
  },
  {
    id: "hf-moss-tts-15",
    ...
    notes: "Strong independent voice fallback; current Space runs on ZeroGPU.",
    priority: 155,
  },
  {
    ...
    kind: "public",
    description: "Multilingual TTS and voice cloning across a broad language set.",
    capabilities: ["voice", "voice-clone", "tts", "multilingual-tts"],
    url: "https://huggingface.co/spaces/ResembleAI/Chatterbox-Multilingual-TTS",
    notes: "Independent high-quality voice fallback; current public Space runs on ZeroGPU.",
    priority: 150,
  },
  {
    id: "hf-seed-vc",
    ...
    notes: "Primary no-training voice-conversion fallback; use only voices the user owns or is authorized to transform.",
    priority: 160,
  },
  {
    id: "hf-applio",
  ...
  },
  {
    ...
    notes: "Primary modern ASR candidate; use only when its live endpoint matches the recording input.",
    priority: 170,
  },
  {
  ...
  },
  {
    ...
    name: "Qwen Image",
    kind: "public",
    description: "Official Qwen image generation for high-quality artwork and covers.",
    capabilities: ["image", "artwork", "cover"],
    url: "https://huggingface.co/spaces/Qwen/Qwen-Image",
    notes: "Current official Qwen image Space running on ZeroGPU.",
    priority: 175,
  },
  {
    ...
    notes: "Use when an input image is supplied; live schema discovery handles the exact edit inputs.",
    priority: 170,
  },
  {
    id: "hf-z-image",
  ...
  },
  {
    ...
    name: "SDXL Turbo",
    kind: "public",
    description: "Mature open image-generation and image-editing fallback.",
  ...
  },
  {
    ...
    notes: "Primary free video route; current Space runs on ZeroGPU.",
    priority: 170,
  },
  {
    id: "hf-wan-22-fast",
    name: "Wan 2.2 Fast",
    kind: "public",
    description: "High-quality open image-to-video generation optimized for free ZeroGPU inference.",
    ...
    notes: "Current public Wan2.2 14B Fast Space. Live API discovery is mandatory.",
    priority: 165,
  },
  {
    ...
    notes: "Fallback only when LTX 2.3 or Wan2.2 is unavailable.",
    priority: 120,
  },
  {
    id: "hf-demucs",
