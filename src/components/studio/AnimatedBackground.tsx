...
export function AnimatedBackground() {
  ...
  return (
    ...
    >
      <div
        className="absolute inset-0 animate-slow-zoom bg-cover bg-center opacity-48"
      ...
      <div className="absolute inset-x-0 top-0 h-24 opacity-95">
        <div className="paint-drip-field h-full w-full animate-paint-shimmer" />
      </div>
