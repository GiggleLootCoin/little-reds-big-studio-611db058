  ...
  const steps = [
    {
      ...
      body: "Add a song, image or voice reference to get started.",
    ...
    },
    {
      ...
      body: "Write, generate or refine lyrics with Buddy.",
      done: Boolean(studio.lyrics),
    },
    {
      id: "honest-critiquer-ai-song-coach",
      icon: <Brain className="size-4" />,
      title: "Get Buddy's creative take",
      body: "Turn your idea into a practical upgrade plan.",
      done: false,
    },
    {
      ...
      body: "Turn your music and imagery into a video plan.",
    ...
    <div className="space-y-2">
      {!user && (
        <p className="rounded-xl border border-dashed border-primary/50 bg-primary/5 p-3 text-xs text-muted-foreground">
          ...
          to save your projects across sessions.
        </p>
      )}
      {steps.map((s, i) => (
        <button
