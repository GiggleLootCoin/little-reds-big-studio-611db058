    ...
    >
      ...
      >
        ...
        <span className="min-w-0 flex-1">
          {eyebrow && (
            <span className="block text-[0.65rem] font-semibold uppercase tracking-[0.22em] text-primary">
              {eyebrow}
            </span>
          )}
      ...
      <div
        id={`${panelId}-content`}
        hidden={!open}
        className="animate-fade-in space-y-4 border-t border-border/60 px-4 pb-5 pt-4"
      >
        {children}
      </div>
    </section>
