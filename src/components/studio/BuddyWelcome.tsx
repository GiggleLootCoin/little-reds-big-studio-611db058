...
const TASKS: { task: BuddyTask; title: string; copy: string; icon: typeof Music2 }[] = [
  ...
  },
  {
    ...
    copy: "Write original lyrics locally in your browser.",
    icon: Sparkles,
  },
  {
    task: "artwork",
    title: "Generate Image",
    copy: "Create artwork with the free image engine.",
    icon: Image,
  },
  {
    task: "video",
    title: "Generate Video",
    copy: "Turn your image and audio into motion.",
    icon: Video,
  },
  {
    task: "voice",
    title: "Voice Tools",
    copy: "Clone or swap voices you have permission to use.",
    icon: Mic,
  },
  {
    task: "writing",
    title: "Talk to Buddy",
    copy: "Open Live Voice and chat hands-free.",
    icon: MessageCircle,
  },
];
        ...
        <div className="flex items-start justify-between gap-5">
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-4 max-w-2xl text-sm leading-6 text-white/70 sm:text-base sm:leading-7">
              Your music, your images, your logo and your Buddy stay at the heart of the Studio.
              Pick a job below or talk to Buddy live. Heavy generation runs through free/open
              engines and only counts as complete when an actual result comes back.
            </p>
        ...
        <div className="mt-6 flex items-center gap-3 sm:hidden">
          ...
          <div>
            <p className="font-display text-sm font-bold text-white">
              Buddy is your animated AI assistant.
            </p>
                  ...
                  setBuddyStatus(plan.mode === "unavailable" ? "error" : "thinking", {
                    ...
                    message:
                      plan.mode === "unavailable"
                        ? "That route is unavailable right now. I won't pretend it ran."
                        : `Opening ${title}…`,
                  });
                  onChoose(task);
                }}
