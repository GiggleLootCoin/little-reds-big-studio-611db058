...
function sourceFor(logical: LogicalId, name: string, inputs: Record<string, unknown>) {
  ...
  if (n.includes("language") || n === "lang") return inputs.language;
